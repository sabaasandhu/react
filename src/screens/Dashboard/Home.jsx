...
const Home = () => {
  ...
  return (
    ...
    <div className='mt-2'>
          <Carasol/>
      <h1 className='text-center italic font-extrabold text-2xl h-50  text-wrap bg-gradient-to-tl from-teal-500 via-teal-700 to-orange-500  shadow-lg sticky mt-2  text-black'> MOST SELLING PRODUCTS👇</h1>
