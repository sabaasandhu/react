...
import { Sparkles, PackageX, ShieldPlus } from 'lucide-react'
  ...
  return (
    <div className='min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors'>
      ...
      <div className='flex flex-col items-center justify-center mt-10 mb-8 px-4'>
        <span className='flex items-center gap-2 px-4 py-1 rounded-full bg-indigo-100 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-300 text-xs font-semibold uppercase tracking-wider mb-3'>
        ...
        <div className='max-w-7xl mx-auto px-4 pb-16'>
          {products && products.length > 0 ? (
            ...
            <div className='flex flex-col items-center justify-center text-center bg-white dark:bg-gray-800 border border-red-100 dark:border-red-900/40 rounded-2xl shadow-sm max-w-md mx-auto py-12 px-6'>
              <PackageX className='text-red-400 mb-4' size={48} strokeWidth={1.5} />
              ...
              {isAdmin && (
                ...
                >
                  <ShieldPlus size={16} /> Add New Product
                </a>
              )}
            </div>
          )}
