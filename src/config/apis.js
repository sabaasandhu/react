...
export const authApis = {
    ...
    findUser: "https://django-production-02ca.up.railway.app/api/auth/find-user/",  
};
export const cartApis = {
    base: "https://django-production-02ca.up.railway.app/api/cart/",
    add: "https://django-production-02ca.up.railway.app/api/cart/add/",
    remove: "https://django-production-02ca.up.railway.app/api/cart/remove/",
    list: "https://django-production-02ca.up.railway.app/api/cart/",
    clear: "https://django-production-02ca.up.railway.app/api/cart/clear/",  
};

export const orderApis = {
    create: "https://django-production-02ca.up.railway.app/orders/create/",
    myOrders: "https://django-production-02ca.up.railway.app/api/orders/my-orders/",
    orderDetails: (orderId) => `https://django-production-02ca.up.railway.app/api/orders/${orderId}/`,
    allOrders: "https://django-production-02ca.up.railway.app/api/admin/orders/",
    updateStatus: (orderId) => `https://django-production-02ca.up.railway.app/api/admin/orders/${orderId}/update-status/`,
};
